...
from PyQt6.QtWidgets import (
    QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QGroupBox,
    QTreeView, QFileDialog, QMessageBox, QScrollArea, QStatusBar,
...
# -----------------------------
# QFileSystemModel compatibility
# -----------------------------
try:
